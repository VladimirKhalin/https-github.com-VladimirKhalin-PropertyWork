...
extension ColorResource {
    ...
    static let border = ColorResource(name: "BorderColor", bundle: resourceBundle)

    /// The "ButtonColor" asset catalog color resource.
    static let button = ColorResource(name: "ButtonColor", bundle: resourceBundle)

    /// The "ButtonPressed" asset catalog color resource.
    static let buttonPressed = ColorResource(name: "ButtonPressed", bundle: resourceBundle)

    /// The "CheckCell" asset catalog color resource.
    static let checkCell = ColorResource(name: "CheckCell", bundle: resourceBundle)

    /// The "MaskColor" asset catalog color resource.
    static let mask = ColorResource(name: "MaskColor", bundle: resourceBundle)

    /// The "OrangeButton" asset catalog color resource.
    static let orangeButton = ColorResource(name: "OrangeButton", bundle: resourceBundle)
    ...
    /// The "modalColor" asset catalog color resource.
    static let modal = ColorResource(name: "modalColor", bundle: resourceBundle)

    /// The "tapbarcolor" asset catalog color resource.
    static let tapbarcolor = ColorResource(name: "tapbarcolor", bundle: resourceBundle)
...
extension ImageResource {
    ...
    /// The "BackArr" asset catalog image resource.
    static let backArr = ImageResource(name: "BackArr", bundle: resourceBundle)
    ...
    /// The "download-cloud" asset catalog image resource.
    static let downloadCloud = ImageResource(name: "download-cloud", bundle: resourceBundle)
    ...
    /// The "favoritesNo" asset catalog image resource.
    static let favoritesNo = ImageResource(name: "favoritesNo", bundle: resourceBundle)

    /// The "favoritesYes" asset catalog image resource.
    static let favoritesYes = ImageResource(name: "favoritesYes", bundle: resourceBundle)
    ...
    /// The "s_left2" asset catalog image resource.
    static let sLeft2 = ImageResource(name: "s_left2", bundle: resourceBundle)
    ...
    /// The "s_right2" asset catalog image resource.
    static let sRight2 = ImageResource(name: "s_right2", bundle: resourceBundle)
    ...
    /// The "share-2" asset catalog image resource.
    static let share2 = ImageResource(name: "share-2", bundle: resourceBundle)
