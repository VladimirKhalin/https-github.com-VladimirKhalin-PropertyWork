...
class GTA_GameModesViewController: GTAModes_NiblessViewController {
    ...
    private let modelScreen: GTAModes_MainModel
  ...
  //  private let searchContainer = UIView()
    ...
    init(model: GTAModes_GameModesModel, modelScreen: GTAModes_MainModel) {
        self.model = model
...
//        searchContainer.withCornerRadius(20.0)
        ...
        tableView.registerReusableCell(cellType: GTAModes_TableViewCell_New.self)
...
extension GTA_GameModesViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell: GTAModes_TableViewCell_New = tableView.dequeueReusableCell(indexPath)
...
//        }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
       // modelScreen.gta_selectedItems(index: 4)
        
        let yInfo = GTA_GameModesInfoViewController(model: model)
