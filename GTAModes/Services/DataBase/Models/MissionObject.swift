 ...
 //   let task: MissionCategory
    ...
    //    case randomEvents = "RandomEvents"
     ...
     //   case strangersAndFreaksHobbiesAndPastimes = "StrangersAndFreaksHobbiesAndPastimes"
        case sideMission = "Slide missionn"
    //    case mandatoryMissionHeist = "MandatoryMissionHeist"
        case branchingChoiceHeist = "Branching Choice Heist"
        case branchingChoice = "Branching Choice"
        case missableMission = "Missable mission"
        case mandatoryMission = "Mandatory mission"
...
public struct MissionItem {
    ...
    private enum CodingKeys: String, CodingKey {
        case categoryName = "hfhju8900"
        case missionName = "filter"
    }
